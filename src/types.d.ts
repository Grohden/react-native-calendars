...
export interface CalendarTheme extends CalendarThemeIdStyles {
    arrowColor?: string;
...
export interface CalendarThemeIdStyles {
    ...
    'stylesheet.expandable.main'?: CalendarThemeIdStyle;
}

export type CalendarThemeIds = keyof CalendarThemeIdStyles
